...
public class MapTweaks {
	...
	public static void tweak(NavigationGraphBuilder navBuilder) {
		...
		if (navBuilder.isMapName("CTF-BP2-Concentrate")) tweakCTFConcentrate(navBuilder);
	...
	private static void tweakCTFConcentrate(NavigationGraphBuilder navBuilder) {
        ...
        navBuilder.removeEdgesBetween("CTF-BP2-Concentrate.PathNode4", "CTF-BP2-Concentrate.InventorySpot46");
        navBuilder.removeEdgesBetween("CTF-BP2-Concentrate.PathNode4", "CTF-BP2-Concentrate.InventorySpot47");
        navBuilder.removeEdgesBetween("CTF-BP2-Concentrate.PathNode4", "CTF-BP2-Concentrate.InventorySpot48");
        navBuilder.removeEdgesBetween("CTF-BP2-Concentrate.PathNode4", "CTF-BP2-Concentrate.InventorySpot49");
        navBuilder.removeEdgesBetween("CTF-BP2-Concentrate.PathNode4", "CTF-BP2-Concentrate.PathNode46");
        navBuilder.removeEdge("CTF-BP2-Concentrate.PathNode4", "CTF-BP2-Concentrate.UTJumppad2");

        //CTF-BP2-Concentrate.UTJumpPad2 UtJumpPad2 utJumpPad2 utjumppad2 UTJumppad2 ?????
        navBuilder.removeEdgesBetween("CTF-BP2-Concentrate.PathNode20", "CTF-BP2-Concentrate.InventorySpot42");
        navBuilder.removeEdgesBetween("CTF-BP2-Concentrate.PathNode20", "CTF-BP2-Concentrate.InventorySpot43");
        navBuilder.removeEdgesBetween("CTF-BP2-Concentrate.PathNode20", "CTF-BP2-Concentrate.InventorySpot44");
        navBuilder.removeEdgesBetween("CTF-BP2-Concentrate.PathNode20", "CTF-BP2-Concentrate.InventorySpot45");
        navBuilder.removeEdgesBetween("CTF-BP2-Concentrate.PathNode20", "CTF-BP2-Concentrate.PathNode47");
        navBuilder.removeEdgesBetween("CTF-BP2-Concentrate.PathNode20", "CTF-BP2-Concentrate.UTJumppad0");
